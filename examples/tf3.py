...
def construt_feature_columns(input_features):
...
def train_model( learning_rate, steps, batch_size, training_examples, training_targets,
  ...
  linear_regressor = tf.estimator.LinearRegressor(feature_columns=construt_feature_columns(training_examples), optimizer = my_optimizer)
